...
const kanbanTasks = {
  quotation: [
    ...
    // ... add more tasks for this column
  ],
  order: [],
  approval: [],
  outsourcing: [],
  ...
  inspection: [],
  shipping: []
  // Fill out tasks for other columns as needed
}
          ...
          <div className="overflow-y-auto" style={{ maxHeight: 'calc(90vh - 140px)' }}>
            <div className="px-12 py-10">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 max-w-4xl mb-16">
                ...
                {/* Only show the date row for non-quotation columns */}
                    ...
                    {(kanbanTasks[column.id] ?? []).map((task) => (
                      ...
                      >
                        <div className="space-y-3">
                          ...
                          {/* Only show date on card for non-quotation columns */}
                          {column.id !== "quotation" && (
                          ...
                          {/* For quotation, just show last edited */}
                          {column.id === "quotation" && (
                            <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                              <div className="flex items-center gap-1 text-gray-400">
                                <Clock className="w-3 h-3" />
